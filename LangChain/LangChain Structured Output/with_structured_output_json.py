...
json_schema = {
  ...
  "properties": {
    "key_themes": {
      ...
      "description": "Identify key themes discussed and write them down in list."
    },
    "summary": {
      "type": "string",
      "description": "Generate a brief summary of the review."
    },
    "sentiment": {
      "type": "string",
      "enum": ["pos", "neg"],
    ...
    "pros": {
      ...
      "description": "List down all the pros of the product in a list."
    },
    "cons": {
      "type": ["array", "null"],
      "items": {
      ...
      "description": "List down all the cons of the product in a list."
    },
    "name": {
      "type": ["string", "null"],
      "description": "Mention the name of the reviewer ONLY WHEN IT IS MENTIONED IN THE REVIEW. If not then return null."
    }
  },
  "required": [
    "key_themes",
